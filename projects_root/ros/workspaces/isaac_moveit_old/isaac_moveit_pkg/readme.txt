...
# see https://wiki.ros.org/ROS/Tutorials/CreatingPackage
# Build package:
cd projects_root/ros/workspaces/isaac_moveit
colcon build --packages-select isaac_moveit_pkg
source install/setup.bash
# Running after build   
ros2 run isaac_moveit_pkg your_script_name
