...
def main():
    ...
    cost_live_plotting_cfgs = [{'live_plotting': False, 'save_plots': False}, {'live_plotting': True, 'save_plots': False}]
    if OBS_PREDICTION:
    ...
    for i in range(n_robots):
        robots.append(FrankaMpc(
            ...
            override_particle_file=f'projects_root/projects/dynamic_obs/dynamic_obs_predictor/cfgs/override_particle_mpc_files/{i}.yml'
            )
        )
