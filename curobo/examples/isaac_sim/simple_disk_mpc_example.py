#!/usr/bin/env python3
#
# Simple disk robot MPC example based on mpc_example.py but with self-collision disabled
#
...
def main():
    ...
    # Load simple disk robot configuration
    robot_cfg = load_yaml(join_path(get_robot_configs_path(), "simple_disk.yml"))["robot_cfg"]
    ...
    # IMPORTANT: Disable self-collision checking for single-link robot
    mpc_config = MpcSolverConfig.load_from_robot_config(
        ...
        self_collision_check=False,  # DISABLED for simple disk robot
