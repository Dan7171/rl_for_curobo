...
Inspired by: 
1. For the making of action graphs in code: https://github.com/moveit/moveit2_tutorials/blob/main/doc/how_to_guides/isaac_panda/launch/isaac_moveit.py 
2. For the contents and most of the logic of isaac sim moveit and rviz: https://www.youtube.com/watch?v=pGje2slp6-s 
"""
