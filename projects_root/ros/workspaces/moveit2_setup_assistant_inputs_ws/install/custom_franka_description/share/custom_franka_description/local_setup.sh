...
: ${AMENT_CURRENT_PREFIX:="/workspace/rl_for_curobo/projects_root/ros/workspaces/moveit2_setup_assistant_inputs_ws/install/custom_franka_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_franka_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_franka_description/environment/path.sh"
