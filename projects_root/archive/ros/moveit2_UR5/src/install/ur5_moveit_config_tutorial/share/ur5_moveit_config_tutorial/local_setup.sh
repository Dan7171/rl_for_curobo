...
: ${AMENT_CURRENT_PREFIX:="/workspace/moveit2_UR5/src/install/ur5_moveit_config_tutorial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur5_moveit_config_tutorial/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur5_moveit_config_tutorial/environment/path.sh"
