...
if True: # imports and initiation (put it in an if statement to collapse it)
    ...
    if SIMULATING:
        ...
        from projects_root.utils.issacsim import get_performance_mode_prebuilt_setup, setup_sim_performance
        ...
        setup_sim_performance(my_world, **get_performance_mode_prebuilt_setup('balanced'))
